...
- [ ] **SITE-ARCH-032 · House / Rooms boundary sharpening:** House should explain architecture and relationships; Rooms should explain knowledge ownership and provide Room entry. Their current destination overlap is the strongest among major audited pages. Remove duplicated “directory” behavior from one side while preserving reciprocal House ↔ Rooms orientation.
