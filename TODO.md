...
- [~] **READ-004 · Dead-end reader audit:** architecture audit now treats Home-only registered routing as a dead end rather than counting Home as a meaningful continuation. Remaining: repair any flagged public surfaces with an owner or adjacent-subject exit.
