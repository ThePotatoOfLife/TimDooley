...
- [~] **WM-010/012/013/016 · Accessibility/mobile:** core focus return, menu Escape behavior, Inspector focus restoration, active-layer live-region summaries, non-color analytical redundancy, AK/HI/DC presence and narrow-screen selected-label readability are implemented and validator-backed. Remaining: broader overlapping-menu/very-small-viewport scenarios plus continued globe/dense-Northeast visual review.
