...
- [~] **NAV-BUG-002 · “Read” means read:** architecture audit inventories visible Read/Open/Enter anchors; named `Open X` links are accepted when they land on the matching X hub/explorer, while Read/Enter and mismatched Open promises remain review warnings. Remaining: review the reduced genuine mismatch set and relabel or retarget only those cases.
