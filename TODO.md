...
- [x] **CIA-BANK-001 · Mud Bank public surface:** add a live CIA bank showing welfare, event adjustments and approximate fictional sUSD balances for all canonical dossiers, with per-second ticking and individual deep links.
- [x] **CIA-BANK-002 · Current balance snapshot:** add `knowledge/cia/mud-bank-snapshot-2026-09-21.json` for the current/recovery desk; DIM/TXT remain zero-weight disputed rather than automatically negative, while sourced growth/repair/yield events move other accounts.
