...
- [~] **ACCESS-008 · Mobile collision audit:** the shared dock already publishes measured `--site-access-clearance`; journey ribbon and homepage counter consume it, and the floating TTS selection control now clamps above it. Remaining: audit map inspectors and other bottom-fixed/form controls on narrow screens before full closure.
