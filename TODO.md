...
- [~] **ACCESS-013 · Specialist local-nav budget:** second authored-reader wave now compacts Axis, Elevator, Paths, Politics, Story, Timeline, Trinity, Works, World Systems and Foundation Timeline in addition to the first major-reader wave; explicit built-site budgets cover these surfaces. Remaining: review the smaller residual authored-specialist set surfaced by the architecture audit.
