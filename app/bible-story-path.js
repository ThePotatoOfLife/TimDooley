...
const stages=[
  {id:'beginnings',label:'Beginnings',subtitle:'Creation and the early world',summary:'Genesis opens with creation, human vocation, fracture, flood and the scattering of nations. This is the Bible’s first great field of origins, boundaries, exile and renewed beginnings.',books:['Genesis'],reference:'Genesis 1:1-2:3',query:'creation garden tree life breath image flood babel'},
  {id:'ancestors',label:'Ancestors',subtitle:'Abraham, Isaac, Jacob and Joseph',summary:'The story narrows from the nations to one family. Promise, inheritance, sibling conflict, exile, reconciliation and blessing become recurring structures.',books:['Genesis'],reference:'Genesis 12:1-9',query:'abraham jacob joseph promise blessing inheritance'},
  {id:'exodus',label:'Exodus and Covenant',subtitle:'Liberation, wilderness and Torah',summary:'Israel is brought out of slavery, formed through covenant, taught how to live, and carried through the wilderness toward a land it has not yet entered.',books:['Exodus','Leviticus','Numbers','Deuteronomy'],reference:'Exodus 3:1-15',query:'exodus covenant wilderness moses law tabernacle'},
  {id:'land',label:'Land and Judges',subtitle:'Settlement, cycles and fragile leadership',summary:'Joshua through Ruth moves through conquest traditions, settlement, repeated breakdown and local deliverance. Ruth offers a quieter story of loyalty, provision and belonging.',books:['Joshua','Judges','Ruth'],reference:'Judges 2:10-23',query:'land judges deliverance cycle ruth'},
  {id:'kingdom',label:'Kings and Kingdom',subtitle:'Saul, David, Solomon and the divided kingdoms',summary:'The monarchy rises, centralizes worship and power, fractures, and repeatedly tests what kingship is for. Psalms and royal traditions grow beside this world.',books:['1 Samuel','2 Samuel','1 Kings','2 Kings','1 Chronicles','2 Chronicles'],reference:'2 Samuel 7:8-17',query:'david king kingdom throne house shepherd'},
  {id:'prophets',label:'Prophets and Crisis',subtitle:'Warning, judgment, hope and exile',summary:'Prophets confront rulers, worship, injustice and covenant failure while also speaking of remnant, return, renewal, new covenant and restored creation.',books:['Isaiah','Jeremiah','Lamentations','Ezekiel','Daniel','Hosea','Joel','Amos','Obadiah','Jonah','Micah','Nahum','Habakkuk','Zephaniah'],reference:'Isaiah 40:1-11',query:'prophet exile judgment restoration remnant new covenant'},
  {id:'return',label:'Return and Rebuilding',subtitle:'Homecoming after exile',summary:'Ezra, Nehemiah and the later prophets focus on return, rebuilding, identity, temple, city and the difficult question of what restoration actually means.',books:['Ezra','Nehemiah','Esther','Haggai','Zechariah','Malachi'],reference:'Ezra 1:1-5',query:'return rebuild temple city gate restoration zechariah'},
  {id:'wisdom',label:'Wisdom and Prayer',subtitle:'A thread running across the story',summary:'Job, Psalms, Proverbs, Ecclesiastes and Song of Solomon do not fit into one simple historical slot. They are better read as an ongoing stream of prayer, wisdom, suffering, love and reflection.',books:['Job','Psalms','Proverbs','Ecclesiastes','Song of Solomon'],reference:'Psalm 1',query:'wisdom psalm prayer tree fruit path'},
  {id:'jesus',label:'Jesus',subtitle:'The four Gospel witnesses',summary:'Matthew, Mark, Luke and John tell the story of Jesus through overlapping but distinct portraits: teaching, healing, conflict, death, resurrection and recognition.',books:['Matthew','Mark','Luke','John'],reference:'Mark 1:1-15',query:'jesus son of man kingdom cross resurrection door bread shepherd'},
  {id:'mission',label:'Church and Mission',subtitle:'Acts and the expanding movement',summary:'Acts follows the movement from Jerusalem outward through witness, conflict, travel, community formation and mission across the eastern Mediterranean.',books:['Acts'],reference:'Acts 1:1-11',query:'acts spirit witness mission church ascension'},
  {id:'letters',label:'Letters and Communities',subtitle:'Teaching life inside the movement',summary:'The New Testament letters argue about faith, practice, community, suffering, leadership, freedom, unity and hope. They are conversations with real communities, not one continuous narrative.',books:['Romans','1 Corinthians','2 Corinthians','Galatians','Ephesians','Philippians','Colossians','1 Thessalonians','2 Thessalonians','1 Timothy','2 Timothy','Titus','Philemon','Hebrews','James','1 Peter','2 Peter','1 John','2 John','3 John','Jude'],reference:'Romans 12:1-8',query:'body community faith love service inheritance house'},
  {id:'new-creation',label:'New Creation',subtitle:'Revelation and the renewed city',summary:'Revelation gathers throne, Lamb, witness, judgment, Babylon, river, tree and city imagery into a final vision of conflict, renewal and divine presence.',books:['Revelation'],reference:'Revelation 21:1-7',query:'revelation new jerusalem river tree life throne lamb zion'}
];
