(()=>{
  ...
  function render(){
    ...
    // Idempotency is the permanent guard against render/mutation feedback loops.
    ...
    // Never observe our own DOM writes. The previous implementation removed and
    // re-added this panel while observing #reader, creating an infinite mutation loop.
    observer?.disconnect();
    try{
      existing?.remove();
