...
function setView(host,view){$('[data-news-view]',host).forEach(b=>b.setAttribute('aria-pressed',String(b.dataset.newsView===view)));$('[data-news-view-panel]',host).forEach(p=>p.classList.toggle('is-active',p.dataset.newsViewPanel===view));const more=$('.news-secondary-drawer',host);if(more&&view!=='latest')more.open=true}
