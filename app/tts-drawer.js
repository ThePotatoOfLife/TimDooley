(function(root,factory){
  ...
  function createPageHighlighter(options={}){
    ...
    function highlight(container,range,excludeSelector='',follow=false){
      ...
      if(follow)centerDomRange(win,doc,domRange);
      return true;
    }
  ...
  function mount(options={}){
    ...
    return {element:host,setPayload,getPayload:()=>payload,playSection,open:()=>setState('open'),expand:()=>setState('expanded'),close:()=>setState('closed'),stop:()=>engine?.stop(),isFollowing:()=>followReading,engine};
  }
