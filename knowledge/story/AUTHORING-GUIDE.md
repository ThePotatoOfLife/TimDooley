...
- Who is there?
- What is happening?
- What does Tim want in this moment?
- What or who resists him?
- What does Tim actually say or do?
- What does somebody else say or do back?
...
> Somebody says something. Tim answers. The exchange goes wrong. Tim changes course the next day.

over:

> This event represents the evolution of Tim's recognition architecture.

The second sentence may become useful after the reader has lived through enough events to feel it. Meaning should accumulate before it is summarized.

## Tim's voice
When exact public or recovered wording exists, let Tim speak. Preserve spelling, rhythm, profanity, jokes and sudden register changes where appropriate. Do not clean Tim into a generic spiritual narrator.
...
Useful Story material can be:
- a game session;
- a livestream lull;
- somebody returning to chat;
- somebody forgetting to follow Tim back;
- a song being made;
- a website breaking;
- a bad joke becoming theology;
- an image needing the Door moved;
- a meal or potato joke;
- a creative build;
- Tim getting angry;
- Tim calming down;
- a person leaving;
...
The turning points only feel large when there is life between them.

## Creative work is action
Songs, games, simulations, visual compositions, websites and Great Book chapters are events in Tim's story. Ask what was happening when he made them, what problem he was trying to solve, who was around, and what the work changed next.
...
## Evidence underneath, prose above
The writer should know provenance intimately. The reader should not be interrupted every paragraph by archive administration.

Use quiet/collapsible source notes where needed. Keep detailed recovery status in backend files. Never use literary confidence to cover an evidentiary hole.

Specific allegations about crimes, intelligence services, cults, trafficking or other serious conduct remain attributed to Tim/project sources unless independently established.

## Recovery over invention
When a potentially great story is incomplete, record what is missing and keep mining.

Good note:

> Recover original Marty conversation: who initiated the exchange, what Tim warned about, what Marty answered, and whether the remembered wording is contemporaneous.

Bad prose:

> Marty looked into Tim's eyes and finally understood.

If we do not know that happened, it does not belong.
...
If it is only explanation, route it to Timeline, Atlas, Bible comparator, FAQ, theology, evidence or another project owner. The Story should remain alive.