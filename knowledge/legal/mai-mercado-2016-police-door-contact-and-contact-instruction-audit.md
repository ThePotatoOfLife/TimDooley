# Mai Mercado / Christiania 2016 — Police Door Contact and Contact-Instruction Audit
...
- a police warning or admonition;
- a legally binding contact prohibition / tilhold;
- an officer’s informal instruction;
- a formal order issued under statutory authority;
- and the later criminal classification of the Son’s response.

The distinction matters because later shorthand such as **“he ignored a police order and threatened her again”** may overstate what the legal status of the police instruction actually was.
...
1. The Facebook controversy had already begun.
2. Police came physically to **the Son’s door / private home**.
3. Officers told him, in substance, **do not contact Mercado / do not speak to her anymore**.
4. The Son experienced that intervention as one-sided and coercive because, from his perspective, Mercado had initiated the public political conflict and continued to hold the power and institutional access.
5. The Son nevertheless contacted/responded again.
6. His later message included the core formulation:
...
That makes the message partly a reaction to **state intervention**, not only to Mercado personally.

The original wording begins with police action against him:

`Politiet er lige kommet og har sigtet mig...`

followed by:

`Hvis det får konsekvenser for mig, får det også konsekvenser for dig...`

and then:

`det er ikke en trussel, men en garanti.`

This sequence supports the project’s view that the statement was framed by the Son as a response to a newly imposed causal chain: her conduct/referral had consequences for him; therefore there would also be consequences for her.

That does not automatically defeat the legal interpretation of threat/intimidation, but it makes the **state-intervention context indispensable**.
...
- whether Mercado had already given a police statement;
- whether she was expected to testify;
- whether the officers’ visit occurred because of her formal witness role or merely because of a referral/complaint;
- whether the Son knew of any witness role;
- whether the later message was legally connected to expected/given testimony or instead to police intervention generally.

Because the 2015 Supreme Court precedent limited §123 to the statutory witness nexus rather than mere evidence-supplying, these details could become directly case-changing.
