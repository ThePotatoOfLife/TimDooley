...
def main() -> int:
    ...
    retired_lenses = ROOT / "world-map" / "3d-lenses.js"
    ...
    if retired_lenses.exists():
        errors.append("retired 3d-lenses.js must stay deleted; Layer Registry and Compositor are the canonical analytical owners")
