...
assert.match(siteCss, /safe-area-inset-(?:bottom|left|right|top)/, 'shared mobile layout should account for device safe areas');
assert.match(minimalCss, /100vh[^}]*100dvh|100vh[^}]*100svh/s, 'full-height legacy/minimal layout should keep a vh fallback before a modern mobile viewport unit');
