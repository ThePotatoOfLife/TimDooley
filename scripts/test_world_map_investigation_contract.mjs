...
assert.match(investigation, /event\.key !== 'Escape'/, 'Escape handler should ignore non-Escape keys');
assert.match(investigation, /closeActive\('escape'\)/, 'Escape should close the active investigation surface centrally');
