...
GROUPS: dict[str, list[tuple[str, list[str]]]] = {
    "core": [
        ...
        ("CIA dossier integration", ["python scripts/validate_cia_integration.py"]),
        ...
        ("House governance", [
            ...
            "python scripts/sync_room_public_surfaces.py --check",
            "python scripts/validate_house_inhabitant_routes.py",
            "python scripts/validate_recent_work_integration.py",
    ...
    "world_map": [
        ("Ownership and evidence", [
            "python scripts/validate_world_finance_foundation.py",
            "python scripts/validate_bis_financial_statistics.py",
            "python scripts/validate_financial_institution_topology.py",
            ...
            "python scripts/validate_world_map_subdivision_evidence_projection.py",
            "python scripts/validate_world_map_physical_provider_reliability.py",
            "python scripts/validate_world_map_accessibility.py",
            "python scripts/validate_world_map_subdivision_readability.py",
            "python scripts/validate_world_map_subdivisions.py",
            "python scripts/validate_world_map_subdivision_statistics.py",
            "python scripts/test_world_map_adm1_importer.py",
            "python scripts/validate_world_map_subdivision_sources.py",
        ...
        ("UI geometry and investigation", [
            ...
            "python scripts/validate_world_map_conflict_snapshots.py",
        ...
        ("Context control plane", [
            ...
            "node scripts/test_world_map_top_bar_density.mjs",
            ...
            "node scripts/test_world_map_region_doorway_focus.mjs",
            "node scripts/test_world_map_combined_region_scenario.mjs",
