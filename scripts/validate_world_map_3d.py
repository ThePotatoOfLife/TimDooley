...
def main() -> int:
    ...
    fail_if_missing(selection,("wrappedSegmentCoordinates","geometry_meaning:'relationship_chord'","selectedCodes","activeCode","function toggleCountrySelection","function automaticRelationData","searchParams.set('selected'","selection-chip","data-country-code","clearAll","__potatoAtlasSelection","AUTO_EDGES_ACTIVE","AUTO_EDGES_OTHER","AUTO_EDGES_TOTAL"),"world-map/3d-country-selection.js",errors)
    ...
    print("UI contract: map-first · working selection · Country Pulse · Lenses · automatic relations")
