...
<nav>{doors}<br><a href="{BASE_URL}/questions/">Questions</a> · <a href="{BASE_URL}/faq/">Curated FAQ</a> · <a href="{BASE_URL}/index-a-z/">A–Z</a> · <a href="{BASE_URL}/llms.txt">Machine index</a></nav>
</main></body></html>'''
