...
def lexicon_ids(path):
    ...
    return out
all_records=set()
for path in ['data/nodes.json','data/tree-child-records.json','data/tree-support-records.json','data/tree-concept-records.json','data/graph-registry.json','data/belief-records.json','data/belief-registry.json','data/potatoism-cosmology.json','data/potatoism-glossary.json','data/potatoism-canonical-corpus.json','data/potatoism-concept-registry.json','data/potatoism-dossiers.json','data/potatoism-timeline.json','data/tree.json','data/domain-coupling.json','data/global-graph-bridge.json','data/people-registry.json','data/indicator-catalog.json','data/research.json','data/research-carvings-2026-09.json','data/full-text-coverage.json','data/canonical-texts.json','data/religious-comparative-library.json','data/religious-foundations.json','data/religious-foundations/records.json','data/religious-adjacent/records.json','data/religious-adjacent/deep-expansions.json','data/religious-adjacent/deep-expansions-2.json','data/religious-adjacent/deep-expansions-3.json','data/geometry-records.json','data/events.json','data/european-sector-atlas.json','data/countries/index.json']:
