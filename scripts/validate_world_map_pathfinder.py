...
def main() -> int:
    ...
    for marker in html_markers:
        if marker not in html:
            errors.append(f"3d.html missing path-finder marker: {marker}")
    ...
    print("Path contract: BFS shortest path · active typed filter · URL persistence · explicit evidence boundary")
