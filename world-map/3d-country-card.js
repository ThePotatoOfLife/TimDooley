...
function install() {
  ...
  style.textContent = `
    #atlasCountryCard{position:absolute;left:10px;top:10px;z-index:var(--atlas-z-context,7);width:min(330px,calc(100% - 20px));max-height:calc(100% - 20px);overflow:auto;background:#0a1010ed;border:1px solid #344343;border-radius:13px;padding:11px;box-shadow:0 10px 30px #0009;backdrop-filter:blur(12px)}
