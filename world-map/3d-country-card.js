...
function install() {
  ...
  style.textContent = `
    #atlasCountryCard{position:absolute;left:10px;top:10px;z-index:var(--atlas-z-context,7);width:min(330px,calc(100% - 20px));max-height:calc(100% - 20px);overflow:auto;background:var(--atlas-surface-panel-bg,#0a1010ed);border:1px solid var(--atlas-surface-border,#344343);border-radius:var(--atlas-surface-radius,11px);padding:11px;box-shadow:var(--atlas-surface-shadow,0 10px 28px #0009);backdrop-filter:var(--atlas-surface-blur,blur(11px))}
