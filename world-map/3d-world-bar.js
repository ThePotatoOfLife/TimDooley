  ...
  function syncMenus() {
    ...
    document.querySelectorAll('#atlasWorldBar .atlas-world-menu[data-family]').forEach(menuNode => {
      ...
      if (family === 'relations') {
        ...
        const summary = menuNode.querySelector(':scope > summary'); if (summary) summary.textContent = mode === 'all' ? 'Relations' : `Relations · ${relationLabel(mode)}`;
