// Registry-driven analytical state for the World Relational Atlas.
...
const REGISTRY_URL = '../data/world-atlas-layer-registry.json';
...
function persist() {
  ...
  // Retire ordinary single-Lens URL ownership once composable state is active.
...
function restoreFromUrl() {
  ...
  // Old Lens links remain useful during migration by translating the high-value cases.
  if (!requested.length) {
...
async function loadRegistry() {
  try {
    ...
    loadError = error;
    console.warn('Atlas layer registry unavailable:', error);
