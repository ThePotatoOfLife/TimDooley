...
function installStyle() {
  ...
  style.textContent = `
    ...
    #atlasChainContext{position:absolute;right:10px;bottom:10px;z-index:var(--atlas-z-context,7);width:min(330px,calc(100% - 20px));padding:10px 12px;background:#080b0be8;border:1px solid #625a3c;border-radius:10px;box-shadow:0 8px 24px #0008;backdrop-filter:blur(10px)}
