...
function installStyle() {
  ...
  style.textContent = `
    ...
    #atlasChainContext{position:absolute;right:10px;bottom:10px;z-index:var(--atlas-z-context,7);width:min(330px,calc(100% - 20px));padding:10px 12px;background:var(--atlas-surface-context-bg,#080b0be8);border:1px solid #625a3c;border-radius:var(--atlas-surface-radius,11px);box-shadow:var(--atlas-surface-shadow,0 10px 28px #0009);backdrop-filter:var(--atlas-surface-blur,blur(11px))}
