...
- [~] Consolidate global UI design tokens, z-index bands and common surfaces. Semantic stacking bands are on main; shared menu/context/overlay/panel backgrounds plus border/radius/shadow/blur tokens are now in progress. Spacing/padding convergence remains selective.
