...
- [~] Consolidate global UI design tokens, z-index bands and common surfaces. Semantic stacking bands are on main; shared menu/context/overlay/panel surface tokens are in progress, with spacing/padding convergence still selective.
